...
public class MoleculeQueryFeatures {
  ...
  public static JavaScriptObject getAtomQueryFeatures(
    StereoMolecule oclMolecule,
    int atom
  ) {
    PlainJSObject toReturn = PlainJSObject.create();
    long atomQueryFeatures = oclMolecule.getAtomQueryFeatures(atom);

    toReturn.setPropertyBoolean(
      "aromatic",
  ...
  public static JavaScriptObject getBondQueryFeatures(
    StereoMolecule oclMolecule,
    int bond
  ) {
    PlainJSObject toReturn = PlainJSObject.create();
    ...
    toReturn.setPropertyBoolean(
      "single",
      (bondQueryFeatures & Molecule.cBondTypeSingle) > 0
    );
    toReturn.setPropertyBoolean(
      "double",
      (bondQueryFeatures & Molecule.cBondTypeDouble) > 0
    );
    toReturn.setPropertyBoolean(
      "triple",
      (bondQueryFeatures & Molecule.cBondTypeTriple) > 0
    );
    toReturn.setPropertyBoolean(
      "delocalized",
    ...
    toReturn.setPropertyBoolean(
      "quadruple",
      (bondQueryFeatures & Molecule.cBondTypeQuadruple) > 0
    );
    toReturn.setPropertyBoolean(
      "quintuple",
      (bondQueryFeatures & Molecule.cBondTypeQuintuple) > 0
    );

    toReturn.setPropertyBoolean(
      "notRing",
      (bondQueryFeatures & Molecule.cBondQFNotRing) > 0
    );
    toReturn.setPropertyBoolean(
      "ring",
      (bondQueryFeatures & Molecule.cBondQFRing) > 0
    );

    toReturn.setPropertyBoolean(
      "aromatic",
      (bondQueryFeatures & Molecule.cBondQFAromatic) > 0
    );
    toReturn.setPropertyBoolean(
      "nonAromatic",
    ...
    toReturn.setPropertyInt(
      "ringSize",
      (int) (bondQueryFeatures & Molecule.cBondQFRingSize) >>
        Molecule.cBondQFRingSizeShift
    );

    toReturn.setPropertyInt(
      "brigdeMin",
      (int) (bondQueryFeatures & Molecule.cBondQFBridgeMin) >>
        Molecule.cBondQFBridgeMinShift
    );
    toReturn.setPropertyInt(
      "brigdeSpan",
      (int) (bondQueryFeatures & Molecule.cBondQFBridgeSpan) >>
        Molecule.cBondQFBridgeSpanShift
    );
