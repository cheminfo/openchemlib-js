...
public class JSReactionEncoder {
  ...
  public static final int INCLUDE_RXN_CODE_ONLY =
    ReactionEncoder.INCLUDE_RXN_CODE_ONLY;
  public static final int INCLUDE_DEFAULT = ReactionEncoder.INCLUDE_DEFAULT;

  public static final String MOLECULE_DELIMITER =
    ReactionEncoder.MOLECULE_DELIMITER_STRING;
  public static final String OBJECT_DELIMITER =
    ReactionEncoder.OBJECT_DELIMITER_STRING;
  public static final String PRODUCT_IDENTIFIER = String.valueOf(
    ReactionEncoder.PRODUCT_IDENTIFIER
  );
  public static final String CATALYST_DELIMITER = String.valueOf(
    ReactionEncoder.CATALYST_DELIMITER
  );
  ...
  public static native String encode(
    ...
    if (!options) options = {keepAbsoluteCoordinates: false, mode: @com.actelion.research.gwt.js.api.JSReactionEncoder::INCLUDE_DEFAULT};
    ...
    if ('sortByIDCode' in options) {
      ...
      return @com.actelion.research.gwt.js.api.JSReactionEncoder::encodeSort(Lcom/actelion/research/gwt/js/api/JSReaction;ZZ)(reaction, options.keepAbsoluteCoordinates, options.sortByIDCode)
    }

    if (typeof options.mode !== 'number') options.mode = @com.actelion.research.gwt.js.api.JSReactionEncoder::INCLUDE_DEFAULT;
    options.mode = Math.trunc(options.mode);
    return @com.actelion.research.gwt.js.api.JSReactionEncoder::encodeMode(Lcom/actelion/research/gwt/js/api/JSReaction;ZI)(reaction, options.keepAbsoluteCoordinates, options.mode);
  }-*/;

  private static String encodeSort(
    JSReaction reaction,
    boolean keepAbsoluteCoordinates,
    boolean sortByIDCode
  ) {
    return String.join(
      OBJECT_DELIMITER,
  ...
  public static native JSReaction decode(
    String reaction,
    JavaScriptObject options
  ) /*-{
    if (!options) options = {mode: @com.actelion.research.gwt.js.api.JSReactionEncoder::INCLUDE_DEFAULT};
    options = Object.assign({}, options);

    if ('ensureCoordinates' in options) {
      options.ensureCoordinates = Boolean(options.ensureCoordinates);
      return @com.actelion.research.gwt.js.api.JSReactionEncoder::decodeCoords(Ljava/lang/String;Z)(reaction, options.ensureCoordinates);
    }

    if (typeof options.mode !== 'number') options.mode = @com.actelion.research.gwt.js.api.JSReactionEncoder::INCLUDE_DEFAULT;
    options.mode = Math.trunc(options.mode);
    return @com.actelion.research.gwt.js.api.JSReactionEncoder::decodeMode(Ljava/lang/String;I)(reaction, options.mode);
  }-*/;

  private static JSReaction decodeCoords(
    String strReaction,
    boolean ensureCoordinates
  ) {
    Reaction reaction = ReactionEncoder.decode(
      strReaction,
      ensureCoordinates,
      null
    );
