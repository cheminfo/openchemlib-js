...
public class JSConformerGenerator {
  ...
  public JSMolecule getOneConformerAsMolecule(JSMolecule mol) {
    StereoMolecule result = oclGenerator.getOneConformerAsMolecule(
      mol.getStereoMolecule()
    );
    return result == null ? null : mol;
  }

  public native boolean initializeConformers(
    JSMolecule mol,
    ...
    return this.@com.actelion.research.gwt.js.api.JSConformerGenerator::initializeConformers(Lcom/actelion/research/gwt/js/api/JSMolecule;IIZ)(mol, strategy, maxTorsionSets, use60degreeSteps);
  }-*/;
  ...
  private boolean initializeConformers(
    ...
    return oclGenerator.initializeConformers(
      mol.getStereoMolecule(),
      strategy,
      maxTorsionSets,
      use60degreeSteps
