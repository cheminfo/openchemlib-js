...
public class JSDrawContext implements GenericDrawContext {
  ...
  @Override
  public native GenericImage createARGBImage(
    int width,
    int height
  ) /*-{
    var jsContext = this.@com.actelion.research.gwt.js.api.generic.internal.JSDrawContext::getJsContext()();
  ...
  @Override
  public native void drawCenteredString(
    double x,
    double y,
    String s
  ) /*-{
  ...
  @Override
  public native void drawDottedLine(
    double x1,
    double y1,
    double x2,
    double y2
  ...
  @Override
  public native GenericRectangle getBounds(
    String s
  ) /*-{
    var jsContext = this.@com.actelion.research.gwt.js.api.generic.internal.JSDrawContext::getJsContext()();
  ...
  @Override
  public native void setLineWidth(
    float lineWidth
  ) /*-{
    var jsContext = this.@com.actelion.research.gwt.js.api.generic.internal.JSDrawContext::getJsContext()();
