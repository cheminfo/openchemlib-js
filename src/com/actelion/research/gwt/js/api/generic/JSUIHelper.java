...
public class JSUIHelper implements GenericUIHelper {
  ...
  public native JavaScriptObject createNativeDialog(
    String title
  ) /*-{
    var jsObject = this.@com.actelion.research.gwt.js.api.generic.JSUIHelper::getJsObject()();
  ...
  public GenericImage createImage(String name) {
    if (name.equals("editorButtons.png")) {
      String data =
        ImageData.editorButtonsData0 +
        ImageData.editorButtonsData1 +
        ImageData.editorButtonsData2 +
        ImageData.editorButtonsData3;
      return new JSImage(
        createImageFromBase64(
          ImageData.editorButtonsWidth,
          ImageData.editorButtonsHeight,
          data
        )
      );
      ...
      return new JSImage(
        createImageFromBase64(
          ImageData.esrButtonsWidth,
          ImageData.esrButtonsHeight,
          ImageData.esrButtonsData0
        )
      );
    } else {
      return null;
  ...
  private native JavaScriptObject createImageFromBase64(
    int width,
    int height,
    String base64
  ) /*-{
  ...
  @Override
  public native JSImage createImage(
    int width,
    int height
  ) /*-{
    var jsObject = this.@com.actelion.research.gwt.js.api.generic.JSUIHelper::getJsObject()();
  ...
  @Override
  public GenericPopupMenu createPopupMenu(
    GenericEventListener<GenericActionEvent> consumer
  ) {
