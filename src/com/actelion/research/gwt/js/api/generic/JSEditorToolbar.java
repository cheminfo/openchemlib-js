...
public class JSEditorToolbar implements GenericCanvas {
  ...
  public JSEditorToolbar(
    JSEditorArea jsEditorArea,
    JavaScriptObject jsObject,
    JSUIHelper uiHelper
  ) {
    mGenericToolbar = new GenericEditorToolbar(
      this,
      jsEditorArea.getGenericEditorArea()
    );
    mJsObject = jsObject;
    mUIHelper = uiHelper;
  ...
  public native void setDimensions(
    int width,
    int height
  ) /*-{
