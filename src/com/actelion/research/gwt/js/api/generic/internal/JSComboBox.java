...
public class JSComboBox extends JSComponent implements GenericComboBox {
  ...
  public native void addItem(
    ...
    var component = this.@com.actelion.research.gwt.js.api.generic.internal.JSComboBox::getJsComponent()();
  ...
  @Override
  public native void setSelectedIndex(
    int index
  ) /*-{
    var component = this.@com.actelion.research.gwt.js.api.generic.internal.JSComboBox::getJsComponent()();
  ...
  @Override
  public native void setSelectedItem(
    String item
  ) /*-{
    var component = this.@com.actelion.research.gwt.js.api.generic.internal.JSComboBox::getJsComponent()();
