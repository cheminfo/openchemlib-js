...
public class JSEditorArea implements GenericCanvas {
  ...
  public static final int MODE_MULTIPLE_FRAGMENTS =
    GenericEditorArea.MODE_MULTIPLE_FRAGMENTS;
  public static final int MODE_MARKUSH_STRUCTURE =
    GenericEditorArea.MODE_MARKUSH_STRUCTURE;
  public static final int MODE_REACTION = GenericEditorArea.MODE_REACTION;
  public static final int MODE_DRAWING_OBJECTS =
    GenericEditorArea.MODE_DRAWING_OBJECTS;

  public static final int EDITOR_EVENT_MOLECULE_CHANGED =
    EditorEvent.WHAT_MOLECULE_CHANGED;
  public static final int EDITOR_EVENT_SELECTION_CHANGED =
    EditorEvent.WHAT_SELECTION_CHANGED;
  public static final int EDITOR_EVENT_HIGHLIGHT_ATOM_CHANGED =
    EditorEvent.WHAT_HILITE_ATOM_CHANGED;
  public static final int EDITOR_EVENT_HIGHLIGHT_BOND_CHANGED =
    EditorEvent.WHAT_HILITE_BOND_CHANGED;

  public static final int MOUSE_EVENT_PRESSED = GenericMouseEvent.MOUSE_PRESSED;
  public static final int MOUSE_EVENT_RELEASED =
    GenericMouseEvent.MOUSE_RELEASED;
  ...
  public static final int cPointedHandCursor =
    GenericCursorHelper.cPointedHandCursor;
  ...
  public static final String[] IMAGE_NAME_32 =
    GenericCursorHelper.IMAGE_NAME_32;
  ...
  public JSEditorArea(
    ...
    mDrawArea = new GenericEditorArea(
      new StereoMolecule(),
      mode,
      uiHelper,
      this
    );
    mDrawArea.addDrawAreaListener(
      new GenericEventListener<EditorEvent>() {
        @Override
  ...
  public void fireMouseEvent(
    ...
    GenericMouseEvent gme = new GenericMouseEvent(
      what,
      button,
      clickCount,
      x,
  ...
  public void fireKeyEvent(
    ...
    boolean isCtrlDown,
    boolean isShiftDown,
    boolean isMenuShortcut
  ) {
    GenericKeyEvent gke = new GenericKeyEvent(
      what,
      key,
      isAltDown,
      isCtrlDown,
