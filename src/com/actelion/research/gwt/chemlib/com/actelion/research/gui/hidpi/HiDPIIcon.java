...
public class HiDPIIcon {
  ...
  private static final int[] ICON_SPOT_COLOR = {
    // original spot colors used in icon images (bright L&F)
    0x00503CB4,
    0x00000000,
  };
  private static final int[] DARK_LAF_SPOT_COLOR = {
    // default replacement spot colors for dark L&F)
    0x00B4A0FF,
    0x00E0E0E0,
  };
  ...
  public static void adaptForLookAndFeel(GenericImage image) {
    if (sSpotColor != null) replaceSpotColors(image, sSpotColor);
    else if (LookAndFeelHelper.isDarkLookAndFeel()) replaceSpotColors(
      image,
      DARK_LAF_SPOT_COLOR
    );
  }
