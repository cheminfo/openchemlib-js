export class EditorDialog {
  ...
  setLayout(hLayout, vLayout) {
    ...
    this.vLayout = `${generateLayout(vLayout)} auto`;
  }
  ...
  showDialog(onClose) {
    ...
    form.style.gridTemplateColumns = this.hLayout;
    form.style.gridTemplateRows = this.vLayout;
...
class ComboBox extends Component {
  ...
  setEditable(/* editable */) {
    // TODO: implement editable combo box.
  }
