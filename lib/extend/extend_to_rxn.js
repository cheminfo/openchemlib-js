/**
 * Extends the instance methods toRxn and toRxnV3 in order to remove by
 * default the reaction idCode that is present in the rxn file header.
 * In order to keep it, the option keepIdCode must be set to true.
 * @param {*} Reaction
 */
